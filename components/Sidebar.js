...
const Sidebar = () => {
  ...
  return (
    <div className={`bg-slate-100/90   min-h-screen relative top-0 ${sideIsOpen ? "left-0" : "-left-full sm:left-0"}     no-scrollbar`}>
      <div className="mt-6 flex flex-col justify-start items-start w-full space-y-3 pb-5 ">
        <button className={`side_btn ${!sideIsOpen ? "sm:flex-col" : "sm:space-x-4 px-3 flex-col sm:flex-row sm:px-14"}  `}>
        ...
        <div className="mt-6 flex flex-col justify-start items-start  w-full space-y-3 hidden sm:block ">
          <h4 className="text-gray-800 font-bold px-5 ">
            MORE FROM YOUTUBE
          </h4>
          <button className={`side_btn ${!sideIsOpen ? "sm:flex-col" : "sm:space-x-4 px-3 flex-col sm:flex-row sm:px-14"}  `}>
          ...
          <button className={`side_btn ${!sideIsOpen ? "sm:flex-col" : "sm:space-x-4 px-3 flex-col sm:flex-row sm:px-14"}  `}>
            ...
            <p className="text-base leading-10 whitespace-nowrap  ">Send feedback</p>
          </button>
        </div>
