  ...
  return (
    <div className="bg-slate-100/90  w-auto  h-screen  fixed top-21 overflow-auto  no-scrollbar">
      <div className="mt-6 flex flex-col justify-start items-start  pr-4 w-full space-y-3 pb-5 ">
        <button className="flex text-black hover:text-white focus:bg-slate-400 focus:text-white hover:bg-slate-400 text-gray-400 rounded  items-center sm:space-x-6 w-full pl-4 flex-col sm:flex-row ">
        ...
        <div className="hidden sm:block sm:w-full">
          <button className="flex text-black hover:text-white focus:bg-slate-400 focus:text-white hover:bg-slate-400 text-gray-400 rounded  items-center sm:space-x-6 w-full pl-4">
